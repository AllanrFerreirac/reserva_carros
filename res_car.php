                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-hearder py-3">
                                ...
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/></svg>&nbsp;<b>Reservar Data</b></h4>
                                </div>
                                    <div class="card-body">
                                <?php
                                    include 'conecta.php';
                            ...
                            <form action="data_edita.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group">
                                    <label>Data de Inicio da Reserva</label>
                                    <input type="datetime-local" class="form-control" name="data_inicio" placeholder="" required/>
                                    <br/>
                                    <label>Data Final da Reserva</label>
                                    <input type="datetime-local" class="form-control" name="data_final" placeholder="" required/>
                                    <br/>
                                    <button type="submit" class="btn btn-outline-success">Reservar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-primary" href="reservar.php" role="button">Voltar</a>
                                </form>
                                </div>
                            </div>
                        </div>
