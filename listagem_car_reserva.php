          ...
          <div class="card-body">
            ...
            if($row > 0){
                while($registro = $pesquisa-> fetch_array()){
                    ...
                    echo '<td><button type="button" class="btn btn-outline" data-bs-toggle="modal" data-bs-target="#exampleModal"?id='.$id.'"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-calendar2-date" viewBox="0 0 16 16">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-fan" viewBox="0 0 16 16">
                        ...
                        </svg>&nbsp;<h5 class="modal-title" id="exampleModalLabel">Data da Reserva</h5>
